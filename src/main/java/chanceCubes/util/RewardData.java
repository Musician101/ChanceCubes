...
public class RewardData
{
	...
	{
		return FileUtil.JSON_PARSER.parse(getSchematic("/schematics/village.ccs"));
	}

	public static JsonElement getArrowTrapSchematic()
	{
		return FileUtil.JSON_PARSER.parse(getSchematic("/schematics/arrow_trap.ccs"));
	}

	public static JsonElement getTrampolineSchematic()
	{
		return FileUtil.JSON_PARSER.parse(getSchematic("/schematics/trampoline.ccs"));
	}

	public static JsonElement getWoodlandMansionSchematic()
	{
		return FileUtil.JSON_PARSER.parse(getSchematic("/schematics/mansion.ccs"));
	}
